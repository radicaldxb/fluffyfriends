...
export default function HeroBeforeAfterSlider() {
  ...
  return (
    <div className="relative w-full max-w-full -mx-6 sm:mx-0">
      {/* One clip: rounded rect so images (object-cover) follow the curve — no square corners or gap wedges */}
      <div className="overflow-hidden rounded-[20px] shadow-xl shadow-foreground/10 ring-1 ring-border/50">
        <div
          ref={containerRef}
          className="relative aspect-square w-full cursor-col-resize touch-none select-none overflow-hidden rounded-[20px] bg-muted/40 max-md:aspect-auto max-md:h-[min(54vh,380px)] md:aspect-square md:h-auto md:bg-transparent"
